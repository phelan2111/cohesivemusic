...
function ResetSuccess(props: ResetSuccessProps) {
	return (
		<div className='bg-white/20 rounded-md px-4 py-8 flex flex-col gap-10 justify-center items-center'>
			...
			<div className='text-center flex flex-col gap-2'>
				<p className='text-2xl font-semibold'>{Localize('RESET_PASS_SUCCESS')}</p>
				<p className='text-base max-w-96'>{Localize('RESET_PASS_SUCCESS_DES')}</p>
			</div>
